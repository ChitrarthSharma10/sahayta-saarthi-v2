      ...
      <div className="pt-6">
        ...
        <div className="space-y-1">
          <button
            ...
            className="w-full flex items-center gap-3 px-2.5 py-2 rounded-xl text-xs font-semibold text-[#92929E] hover:text-[#19191F] hover:bg-[#F9F9FC] transition-colors"
          >
            <Settings className="w-4 h-4 shrink-0 text-[#92929E]" />
            <span>Setting</span>
          </button>
          <button
            type="button"
